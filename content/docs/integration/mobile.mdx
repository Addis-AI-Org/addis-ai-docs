...
<Tabs items={['Chat Request', 'Voice 2 Playback', 'Legacy Base64 Playback']}>
  ...
  <Tab value="Voice 2 Playback">
    Voice 2 returns a signed clip URL through your backend.
...
Voice 2 returns a completed clip with a signed audio URL. Your backend should return that URL—or proxy the clip after authorizing the user—and the mobile app can pass it to its native player.

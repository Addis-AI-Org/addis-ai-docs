...
<div className="addis-panel flex items-center gap-2 p-3 font-mono text-sm my-6">
...
<div className="addis-offset-shell addis-grid grid-cols-1 md:grid-cols-3 mt-8">

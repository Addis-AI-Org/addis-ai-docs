---
title: Multimodal
description: Reason over images, audio recordings, and documents through the unified chat API.
icon: Layers
---
...
The **Multimodal** capability extends `Addis-፩-አሌፍ` beyond text. You can upload images, audio files, and documents alongside your prompts to perform complex reasoning tasks.
...
<Callout title="Dedicated Endpoint" type="info">
  Use the chat endpoint with an image or document attachment and an explicit extraction prompt for OCR and document-text extraction.
</Callout>
